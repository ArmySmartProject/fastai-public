...
public interface SystemManageService {
	...
	// system manage - menuGroupMenu 수정
	int updateMenuGroup(Map<String, Object> map);

	// system manage - menuGroupMenu 삭제(삭제 후 등록)
	int deleteMenuGroupMenu(String companyGroupId);

	// system manage - menuGroupMenu 수정(삭제 후 등록)
	...
	Map selectBotIdsByCompanyId(Map<String, String> map);
	...
	List<Map<String, Object>> getCompanyUserCampaigns(String ipt_srchId);
